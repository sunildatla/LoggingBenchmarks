...
using System.Threading.Tasks;
    ...
    {
        public class InstrumentationWithActivitySource : IDisposable
        {
                    ...
                    Task.Run(() =>
                    {
                        ...
                        while (this.listener.IsListening)
                        {
                            try
                            {
                                ...
                                ActivityContext activitycontext = ActivityContext.Parse(context.Request.Headers.Get("traceparent"), "");
                    ...
                    this.requestTask = Task.Run(
                        async () =>
                        {
                            ...
                            //{
                                ...
                                using (var activity = source.StartActivity("CLIENT : POST:" + RequestPath, ActivityKind.Client))
                                {
                                    count++;
